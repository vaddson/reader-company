...
2. Не выдумывай факты, которых нет в материалах. Если ответа в материалах нет — так и скажи, при этом попытайся добавить в конце ответа собственное посянение, поставив в его начало текст "*Собственное пояснение:* ".
